<div class="flex items-center h-16 px-6 overflow-hidden">
    <div class="flex items-center space-x-3 min-w-max">
        <div class="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-lg shadow-sm bg-primary-600">
        ...
        <div x-show="{{ $isMobile ? 'true' : '!sidebarMinimized' }}" 
             ...
             class="flex flex-col">
            <h1 class="text-sm font-bold leading-none text-gray-900">DMS Meksiko</h1>
    ...
    <div class="pt-4 mt-4 border-t border-gray-200">
        ...
        <a href="{{ route('pegadaian.dashboard') }}" 
           class="flex items-center px-3 py-2 text-sm font-medium transition-all duration-200 rounded-xl group
            ...
            <span x-show="{{ $isMobile ? 'true' : '!sidebarMinimized' }}" class="truncate">Dashboard Pegadaian</span>
        </a>
