<div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-100 p-2 mb-8 flex overflow-x-auto gap-2">
    @php
    ...
    <a href="{{ route('admin.reports.pawn') }}" 
       class="flex flex-1 items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all whitespace-nowrap
    ...
    <a href="{{ route('admin.reports.comparison') }}" 
       class="flex flex-1 items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all whitespace-nowrap
