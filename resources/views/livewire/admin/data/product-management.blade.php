                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <button wire:click="toggleActive({{ $product->id }})" 
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-black bg-emerald-100 text-emerald-700 border border-emerald-200">
                                        Active
                                    </span>
                                    @else
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-black bg-rose-100 text-rose-700 border border-rose-200">
                                        Inactive
                                    </span>
                                    @endif
                                </button>
                            ...
                            <td colspan="6" class="px-6 py-20 text-center">
                                <div class="max-w-xs mx-auto text-center">
                                    <div class="h-20 w-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-300">
                                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 11m8 4V4"/></svg>
                                    </div>
                ...
                <form wire:submit.prevent="save" class="p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" wire:model="sku" placeholder="Contoh: FNB-001" 
                                class="w-full px-4 py-3 bg-gray-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <input type="text" wire:model="name" placeholder="Contoh: Coca Cola 330ml" 
                                class="w-full px-4 py-3 bg-gray-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea wire:model="description" rows="2" placeholder="Detail spesifikasi produk..." 
                                class="w-full px-4 py-3 bg-gray-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"></textarea>
                        </div>

                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Harga Jual (Rp)</label>
                            <input type="number" wire:model="price" 
                                class="w-full px-4 py-3 bg-gray-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all font-black text-gray-900 tracking-tight">
                        ...
                        <div class="flex items-center space-x-3 pt-6">
                            <input type="checkbox" wire:model="is_active" id="is_active_product" 
                                class="h-6 w-11 rounded-full border-transparent bg-gray-200 text-indigo-600 focus:ring-transparent focus:ring-offset-0 transition-all cursor-pointer">
