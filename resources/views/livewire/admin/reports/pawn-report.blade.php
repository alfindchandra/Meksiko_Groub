    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500 font-medium">Analisis interaktif performa pinjaman gadai
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
                ...
                <div
                    class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl shadow-[0_8px_30px_rgba(59,130,246,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-blue-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <p class="text-3xl font-black truncate">{{ number_format($summary['total_transactions']) }}</p>
                    </div>
                </div>

                <div
                    class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-3xl shadow-[0_8px_30px_rgba(16,185,129,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-emerald-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <p class="text-3xl font-black whitespace-nowrap">
                            {{ number_format($summary['total_loan_amount'] / 1000000, 1) }}<span
                ...
                <div
                    class="bg-gradient-to-br from-amber-500 to-amber-600 rounded-3xl shadow-[0_8px_30px_rgba(245,158,11,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-amber-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        <p
                            class="text-amber-100 text-[10px] font-bold tracking-wider uppercase mb-3 flex items-center gap-2">
                            <svg class="w-4 h-4 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-3xl font-black whitespace-nowrap">
                            {{ number_format($summary['total_admin_fee'] / 1000, 0) }}<span
                                class="text-xl font-semibold opacity-80 ml-1">K</span>
                        </p>
                    </div>
                </div>

                <div
                    class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-3xl shadow-[0_8px_30px_rgba(99,102,241,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-indigo-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <p class="text-3xl font-black">{{ number_format($summary['active_pawns']) }}</p>
                    </div>
                </div>

                <div
                    class="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-3xl shadow-[0_8px_30px_rgba(6,182,212,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-cyan-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <p class="text-3xl font-black">{{ number_format($summary['redeemed_pawns']) }}</p>
                    </div>
                </div>

                <div
                    class="bg-gradient-to-br from-rose-500 to-rose-600 rounded-3xl shadow-[0_8px_30px_rgba(225,29,72,0.3)] p-5 text-white transform hover:-translate-y-1 transition duration-400 relative overflow-hidden group border border-rose-400/30">
                    <div
                        class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-700 ease-out">
                    </div>
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        <p
                            class="text-rose-100 text-[10px] font-bold tracking-wider uppercase mb-3 flex items-center gap-2">
                            <svg class="w-4 h-4 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-3xl font-black">{{ number_format($summary['overdue_pawns']) }}</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div class="p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200">
                        ...
                        <p class="text-xs text-gray-600 mt-1">Rp {{ number_format($cat->total_loan / 1000000, 1) }}Jt
                        </p>
                    </div>
                    @endforeach
                </div>
                                ...
                                callbacks: {
                                    label: function(context) {
                                        ...
                                        if (context.dataset.yAxisID === 'y1') {
                                            return label + 'Rp ' + Number(context.raw).toLocaleString(
                                                'id-ID');
                                        }
